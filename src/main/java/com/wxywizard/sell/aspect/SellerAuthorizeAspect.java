package com.wxywizard.sell.aspect;
...
public class SellerAuthorizeAspect {
    ...
    @Pointcut("execution(public * com.wxywizard.sell.controller.Seller*.*(..))"+
              "&& !execution(public * com.wxywizard.sell.controller.SellerUserController.*(..))")
    public void verify(){};
